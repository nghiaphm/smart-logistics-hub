...
const docTemplate = `{
        ...
        "/workspaces/{id}/members/{user_id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "User ID (users.id)",
                        "name": "user_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "is_admin flag",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/my-web-app_com_smart-logistic-hub_internal_workspace_dto.SetMemberAdminRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/my-web-app_com_smart-logistic-hub_internal_workspace_dto.WorkspaceUserResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "my-web-app_com_smart-logistic-hub_internal_workspace_dto.SetMemberAdminRequest": {
            "type": "object",
            "properties": {
                "is_admin": {
                    "type": "boolean"
        ...
        "my-web-app_com_smart-logistic-hub_internal_workspace_dto.WorkspaceUserResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
