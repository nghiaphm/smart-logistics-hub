      ...
      <Drawer.Root open={openMobile} onOpenChange={setOpenMobile}>
        <Drawer.Portal>
          ...
          <Drawer.Viewport className="fixed inset-0 z-50 lg:hidden">
            <Drawer.Popup className="absolute inset-y-0 left-0 w-72 max-w-[85vw] bg-admin-sidebar shadow-2xl outline-none transition-transform duration-200 motion-reduce:transition-none data-[open]:translate-x-0 data-[closed]:-translate-x-full">
